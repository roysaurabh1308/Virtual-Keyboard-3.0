...
while(1):
    ...
    try:  #an error comes if it does not find anything in window as it cannot find contour of max area
        ...
        for (x, y, w, h) in faces:
            ...
            roni = frame[x:x+w, y,y:h]
            c=cv2.absdiff(frame, roni)
        
        #define region of interest
        roi2=frame[70:270, 1:240]
        roi=frame[70:270, 400:635]
        
        
        cv2.rectangle(frame,(1,70),(240,270),(0,255,0),0)    
        cv2.rectangle(frame,(400,70),(639,270),(0,255,0),0)    
   ...
   #find contour of max area(hand)
    ...
    #code for finding no. of defects due to fingers
        ...
        for t in temp:
            cv2.circle(roi,t,3,[255,255,255],-1)
